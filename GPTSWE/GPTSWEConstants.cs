...
namespace GPTSWE
{
    internal class GPTSWEConstants
    {
        public static readonly string PersonaText =
            @"
                    You are a genius Software Engineering Intern. I am your boss. Your goal is to complete coding tasks. 
